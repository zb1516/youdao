...
Route::group(['prefix'=>'youdao'],function($router){
    $router->any('paper/paperExamined', 'Youdao\PaperController@paperExamined');//有道第一次处理成功回调地址
    $router->any('paper/questionError', 'Youdao\PaperController@questionError');//有道处理问题试题成功后回调地址
