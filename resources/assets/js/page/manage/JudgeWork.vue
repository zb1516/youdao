            ...
            <div class="data-list-wrapper">
                <table class="data-table">
                    <tr class="title">
                        ...
                        <th class="t-state">判定人已贴题目总数</th>
                        <th class="t-person1">当前剩余任务数</th>
                        <th class="t-person1">操作</th>
                    </tr>
                    <template v-for="judge in judgeList">
                        <tr class="t-body">
                            <td class="b-state">{{judge.id}}</td>
                            <td class="b-state">{{judge.userRealname}}</td>
                            <td class="b-state">{{judge.judgeNum}}</td>
                            <td class="b-person1">{{judge.surplusNum}}</td>
                            <td class="t-time3" style="color:deepskyblue;cursor:pointer" @click="judgeTask(judge.userkey)">清空任务</td>
                        </tr>
                    </template>
                </table>
            </div>
            ...
            <div class="con-wrapper">
                <div class="detial-box">
                    ...
                    <div class="btns">
                        ...
                        <button class="js-ok"  @click="sureJudgeTask">确定</button>
                    </div>
                </div>
            </div>
        </div>
...
<style scoped src="../../static/css/judgment.css"></style>
