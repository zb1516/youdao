...
class VipYoudaoQuestion extends Model
{
    ...
    public function questionAll($searchArgs){
        ...
        for($i=1;$i<=$max;$i++) {
            $result = $this->findAll($condition, ['id' => 'asc'], ['vip_youdao_question.id','vip_youdao_question.quesNumber','vip_youdao_examined.paper_id','vip_youdao_examined.paper_name','vip_youdao_question_details.question_id','vip_youdao_question.many_times','vip_youdao_question.youdao_receive_time','vip_youdao_question.youdao_processing_time','vip_youdao_question.processing_days','vip_youdao_examined.paper_examined_time','vip_youdao_question_details.return_reason_content1','vip_youdao_question_details.return_reason_content2','vip_youdao_question_details.return_reason_answer1','vip_youdao_question_details.return_reason_answer2','vip_youdao_question_details.return_reason_analysis1','vip_youdao_question_details.return_reason_analysis2'], '', $join, $i, $limit);
